...
namespace Weekly_Weather.Migrations
{
    ...
    [Migration("20240118215955_Migration18")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Weekly_Weather.Models.User", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Weekly_Weather.Models.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Weekly_Weather.Models.Forecast", b =>
                {
                    b.HasOne("Weekly_Weather.Models.Location", "Location")
                        .WithOne("Forecast")
                        .HasForeignKey("Weekly_Weather.Models.Forecast", "LocationId")
                        .OnDelete(DeleteBehavior.Cascade);
