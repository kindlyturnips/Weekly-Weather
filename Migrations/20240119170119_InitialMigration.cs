        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    temperature_2m_max = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    temperature_2m_min = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    sunrise = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    sunset = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    precipitation_sum = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    precipitation_probability_max = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    weather_code = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Forecast_Location_ForecastId",
